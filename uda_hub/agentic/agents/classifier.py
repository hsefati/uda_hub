...
if __name__ == "__main__":
    ...
    print(f"Category: {res1.get('category')} | Anchored Ticket: {res1.get('ticket_text')}")

    print("\n--- TEST 2: VIP Support Request ---")
    res2 = classifier_node(state_vip)
    print(f"Category: {res2.get('category')} | Urgency: {res2.get('urgency')} | Anchored Ticket: {res2.get('ticket_text')}")

    print("\n--- TEST 3: Regular Support Request ---")
    res3 = classifier_node(state_regular)
    print(f"Category: {res3.get('category')} | Anchored Ticket: {res3.get('ticket_text')}")
    ...
    print(f"Category: {res4.get('category')} | Anchored Ticket: {res4.get('ticket_text', 'STAYED THE SAME')}")
